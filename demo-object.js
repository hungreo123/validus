...
//     name: "Đùi gà",
//     image: "./images/image1",
//     description: "Đùi gà chất lượng cao",
//     price: 20000,
//     amount: 2,
//     directory: "thực phẩm"
// };
...
// function removeProduct(start, amount) {
//     cart.splice(start, amount);
// }
...
var phanthuong = document.getElementById('reward');

btn.onclick = function() {
    var time = 50;
    a = setInterval(function returnReward() {
        x = reward[Math.floor(Math.random()*reward.length)];
        phanthuong.innerText = "Món quà nhận được: " + x;
        time--;
        if (time == 0) {
            clearInterval(a);
        }
